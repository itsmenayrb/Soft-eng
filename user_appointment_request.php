			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-label-group">
						<input type="text" class="form-control" id="requestfullname" name="fullname" placeholder="Full name" required/>
						<label for="requestfullname">Full name</label>
						<p id="errorFullnameDisplay"></p>
					</div>
					<div class="form-label-group">
						<input type="email" class="form-control" id="requestemail" name="email" placeholder="Email" required/>
						<label for="requestemail">Email</label>
						<p id="errorEmailDisplay"></p>
					</div>
					<div class="form-label-group">
						<input type="text" class="form-control" placeholder="Contact Number" name="contactnumber" maxlength="11" id="requestcontact" required/>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-label-group">
								<input type="text" name="appointmentDate" placeholder="Date of Appointment" id="appointmentDate" class="form-control" required/>
						...
						<div class="col-md-6">
							<div class="form-label-group">
								<input type="text" placeholder="Time of Appointment" name="appointmentTime" id="appointmentTime" class="form-control" required/>
					...
					<div class="form-label-group">
						<textarea name="purpose" id="requestpurpose" cols="70" rows="3" class="form-control border-secondary" required></textarea>
					</div>
